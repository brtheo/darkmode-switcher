export function initDarkmode(cssVarName: string = "darkmode", localStorageKeyName: string = cssVarName) {
...
export function switchDarkmode(cssVarName: string = "darkmode", localStorageKeyName: string = cssVarName) {
